...
export async function updateSandboxOrderStatus(request, response, authorised) {
  ...
  if (issueNumber) await updateOrderNotificationStatus(issueNumber, orderStatus);
  return json(response, 200, { sessionId, orderStatus, notificationIssue: issueNumber, sandbox: true });
}
