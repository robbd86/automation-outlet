...
- marketEvidence must contain the 2 to 4 strongest ACTUAL comparable market references you used. Include source/seller name, URL, price in GBP, condition, evidence type and any meaningful warranty/service note. Never invent a URL, price, warranty or seller. If fewer than 2 trustworthy market references are available, return only the references actually found and lower pricingConfidence accordingly.
- Prefer evidence that most closely matches the exact part, condition, quantity and UK customer proposition. Do not pad marketEvidence with weak references merely to reach four entries.
