...
function looksLikeResult(value) {
  ...
  return Boolean(
    Object.prototype.hasOwnProperty.call(value, "partNumber") ||
    Object.prototype.hasOwnProperty.call(value, "recommendation") ||
    Object.prototype.hasOwnProperty.call(value, "listingTitle") ||
    Object.prototype.hasOwnProperty.call(value, "estimatedRetailGbp")
  );
}
...
function extractStructuredResult(items) {
  ...
  function visit(value, depth = 0) {
    ...
    if (typeof value === "string") {
      ...
      return looksLikeResult(parsed) ? parsed : null;
    }
    ...
    if (looksLikeResult(value)) return value;
