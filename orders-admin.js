...
function render(orders){
 ...
 for(const order of orders){
  ...
  const notificationLink=order.notificationIssue?'<a class="pill good" target="_blank" rel="noopener" href="https://github.com/robbd86/automation-outlet-site/issues/'+esc(order.notificationIssue)+'">AO notification #'+esc(order.notificationIssue)+'</a>':'';
